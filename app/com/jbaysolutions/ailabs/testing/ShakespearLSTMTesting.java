 ...
 * Time: 13:12
 */
public class ShakespearLSTMTesting {
    ...
    public static void main(String[] args) throws Exception {
        ...
        RmsProp updater = new RmsProp();
        updater.setRmsDecay(0.95);
        updater.setLearningRate(0.1);

        Regularization reg = new L2Regularization(0.001);
        ...
        MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
                ...
                .updater(updater)
                .list()
                .layer(0, new LSTM.Builder().nIn(iter.inputColumns())
                        .nOut(lstmLayerSize)
