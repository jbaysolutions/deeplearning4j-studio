    ...
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="createModelModalTitle">Select Score Calculator</h5>
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label class="control-label" for="layerTypeField">Available Score Calculator Types</label>
            <select
              class="custom-select"
              id="layerTypeField"
              v-model="newModel.type"
            >
              <option v-for="item in helper.localScoreCalculator" :value="item.key">{{item.description}}</option>
            </select>
          </div>
